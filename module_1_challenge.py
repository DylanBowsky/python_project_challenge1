...
monthly_disocunt_rate = annual_discount_rate/12
...
for inexpensive_loans in loans:
    if loans <= 500:
        ...
        print("These loans are not cheap to buy currently")

# @TODO: Print the `inexpensive_loans` list
# YOUR CODE HERE!
print("The inexpensive loans are as follows", inexpensive_loans)
